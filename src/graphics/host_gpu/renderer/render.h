...
public:
	...
	// indirect_args is the guest address of the three group counts of an indirect dispatch (0 for
	// a direct one). Counts the GPU wrote are consumed by vkCmdDispatchIndirect, not read back.
