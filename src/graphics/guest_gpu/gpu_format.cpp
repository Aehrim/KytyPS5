...
constexpr FormatInfo kFormatInfo[] = {
    ...
    // Scaled formats sample as their UINT backing and convert to float in the shader.
    {BufferFormat::k16UScaled, 2, 0, 2, true, true},
    {BufferFormat::k8_8UScaled, 2, 0, 2, true, true},
    {BufferFormat::k8_8SScaled, 2, 0, 2, true, true},
...
BufferFormat RemapTextureFormat(BufferFormat format) {
	switch (format) {
		...
		case BufferFormat::k10_11_11UScaled: return BufferFormat::k32UInt;
		// Two-byte scaled formats are read as one 16-bit word; the shader splits and converts.
		case BufferFormat::k16UScaled:
		case BufferFormat::k8_8UScaled:
		case BufferFormat::k8_8SScaled: return BufferFormat::k16UInt;
